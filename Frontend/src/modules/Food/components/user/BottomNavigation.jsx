...
export default function BottomNavigation() {
  ...
  const isUnder250 = location.pathname === "/food/under-250" || location.pathname === "/food/user/under-250"
  const isProfile = location.pathname.startsWith("/food/profile") || location.pathname.startsWith("/food/user/profile")
  const isDelivery = !isUnder250 && !isProfile && (location.pathname === "/food" || location.pathname === "/food/" || location.pathname === "/food/user")
