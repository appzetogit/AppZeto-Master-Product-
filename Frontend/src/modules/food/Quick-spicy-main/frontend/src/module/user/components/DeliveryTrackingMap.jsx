...
import { API_BASE_URL } from '@food/lib/api/config';
import bikeLogo from '@food/assets/bikelogo.png';
import { RouteBasedAnimationController } from '@food/module/user/utils/routeBasedAnimation';
import {
...
} from '@food/module/delivery/utils/liveTrackingPolyline';
import { subscribeOrderTracking } from '@food/lib/realtimeTracking';
...
const DeliveryTrackingMap = ({
  ...
  useEffect(() => {
    import('@food/lib/utils/googleMapsApiKey.js').then(({ getGoogleMapsApiKey }) => {
    ...
    const loadGoogleMapsIfNeeded = async () => {
      ...
      if (!window.google || !window.google.maps) {
        ...
        if (!window.google || !window.google.maps) {
          ...
          try {
            const { getGoogleMapsApiKey } = await import('@food/lib/utils/googleMapsApiKey.js');
